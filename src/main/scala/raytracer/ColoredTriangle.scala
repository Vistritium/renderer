...
class ColoredTriangle protected(val a: Vector3, val b: Vector3, val c: Vector3, override val color: Color, val na: Vector3 = Vector3.up, val nb: Vector3 = Vector3.up, val nc: Vector3 = Vector3.up) extends RayIntersectable with Colored {
...
object ColoredTriangle {
  ...
  def apply(a: Vector3, b: Vector3, c: Vector3, color: Color, na: Vector3 = Vector3.up, nb: Vector3 = Vector3.up, nc: Vector3 = Vector3.up) = new ColoredTriangle(a, b, c, color, na, nb, nc)
